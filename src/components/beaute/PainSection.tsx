...
const cards = [
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <rect x="3" y="6" width="22" height="16" rx="2" stroke="#A67C52" strokeWidth="1.5"/>
        <path d="M9 6V4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2" stroke="#A67C52" strokeWidth="1.5"/>
        <line x1="14" y1="11" x2="14" y2="17" stroke="#A67C52" strokeWidth="1.5" strokeLinecap="round"/>
        <line x1="11" y1="14" x2="17" y2="14" stroke="#A67C52" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <circle cx="14" cy="14" r="10" stroke="#A67C52" strokeWidth="1.5"/>
        <path d="M10 14l3 3 5-5" stroke="#A67C52" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M14 4v3M14 21v3M4 14h3M21 14h3" stroke="#A67C52" strokeWidth="1.2" strokeLinecap="round" opacity="0.4"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path d="M14 3L16.5 10H24L18 14.5L20.5 21.5L14 17L7.5 21.5L10 14.5L4 10H11.5L14 3Z" stroke="#A67C52" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
    ),
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px" }} ref={ref}>
        ...
        >
          ...
          <h2 style={{
            ...
            <span style={{ fontStyle: "italic", color: "#A67C52" }}>Votre site web crée la confiance.</span>
          </h2>
          <p style={{
